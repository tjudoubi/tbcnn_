...
#########正文开始############
dictt = {}
file_string = "D:\\tbcnn_\\CVE-2018-4441.js"
sample, size = get_tree(file_string)
dictt[file_string] = sample
nodes11,children1 = getData_finetune_withoutlabel(file_string,dictt,embeddings_index)
out_put = sess.run(
                [pool_out],
                feed_dict={
                    nodes_node1: nodes11,
